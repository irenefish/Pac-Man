...
//        return false;
    ...
    public void addRenderable(Renderable renderable, char renderableType, int x, int y) {
        if (renderable != null) {
            ...
            } else if (renderableType == RenderableType.BLINKY || renderableType == RenderableType.PINKY || renderableType == RenderableType.INKY ||renderableType == RenderableType.CLYDE) {
